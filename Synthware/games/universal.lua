...
local function addBlur(parent)
	...
	blur.Image = getcustomasset('Synthware/assets/new/blur.png')
...
local hash = loadstring(downloadFile('Synthware/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('Synthware/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('Synthware/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
	tagcallback = {},
...
run(function()
	...
	function whitelist:announce(text)
		...
		if success then
			return sendToast({
				toastTitle = text,
				iconImage = getcustomasset('Synthware/assets/new/vape.png'),
				swipeUpDismiss = true,
		...
		icon.Image = getcustomasset('Synthware/assets/new/vape.png')
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('Synthware/profiles/whitelist.json') and readfile('Synthware/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('Synthware/profiles/whitelist.json', whitelist.textdata)
				end)
			end
